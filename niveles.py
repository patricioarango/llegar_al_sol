...
class Niveles(object):
    def __init__(self,nivel):
        self.nivel = nivel
        if self.nivel == 1:
            self.background = pygame.image.load('assets/images/fondo_bajo.jpg')
        if self.nivel == 2:
            self.background = pygame.image.load('assets/images/fondo2.jpg')
        if self.nivel == 3:
            self.background = pygame.image.load('assets/images/fondo3.jpg')
    ...
    def showPreviaNivel(self,screen):
        if self.nivel == 1:
            ...
            while intro:
                ...
                intro1 = pygame.image.load('assets/images/intronivel1.jpg')
        ...
        if self.nivel == 2:
            ...
            while intro:
                ...
                screen.blit(TextSurf2, TextRect2)
                intro1 = pygame.image.load('assets/images/intronivel2.jpg')
                screen.blit(intro1, (200, 260))
                pygame.display.update()
        ...
        if self.nivel == 3:
            ...
            while intro:
                ...
                TextRect2.center = ((1200 / 2), (170))
                screen.blit(TextSurf2, TextRect2)
                intro1 = pygame.image.load('assets/images/intronivel3.jpg')
        ...
        if self.nivel == 4:
            ...
            while intro:
                ...
                screen.fill((255, 255, 255))
                intro1 = pygame.image.load('assets/images/globos.png')
                altura = altura - 10
                if altura == -600:
                    altura = 800
                ...
                screen.blit(TextSurf, TextRect)
                smallText = pygame.font.Font('assets/fonts/freesansbold.ttf', 50)
